...
void AudioEngine::LoopbackFilterStrategy::OnCallback(ma_device* pDevice, void* pOutput, const void* pInput, ma_uint32 frameCount)
{
	...
	LoopbackStrategy::OnCallback(pDevice, output, input, frameCount);
}
